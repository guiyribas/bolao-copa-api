...
export interface ApiBetBet extends Struct.CollectionTypeSchema {
  collectionName: 'bets';
  info: {
    description: 'Palpites dos participantes para cada partida';
    displayName: 'Bet';
    pluralName: 'bets';
    singularName: 'bet';
  };
...
export interface ApiMatchMatch extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Partidas da Copa do Mundo 2026';
    displayName: 'Partida';
    pluralName: 'matches';
    singularName: 'match';
  };
...
export interface ApiPoolMembershipPoolMembership
  ...
  info: {
    description: 'Participa\u00E7\u00E3o de usu\u00E1rios nos bol\u00F5es com status de pagamento';
    displayName: 'PoolMembership';
    pluralName: 'pool-memberships';
    singularName: 'pool-membership';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hasPaid: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pool-membership.pool-membership'
    > &
      Schema.Attribute.Private;
...
export interface ApiPoolPool extends Struct.CollectionTypeSchema {
  collectionName: 'pools';
  info: {
    description: 'Bol\u00F5es criados pelos usu\u00E1rios';
    displayName: 'Pool';
    pluralName: 'pools';
    singularName: 'pool';
  };
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::pool.pool'> &
      Schema.Attribute.Private;
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Sele\u00E7\u00F5es nacionais qualificadas para a Copa do Mundo FIFA 2026 (48 equipes)';
    displayName: 'Sele\u00E7\u00E3o';
    pluralName: 'teams';
    singularName: 'team';
  };
